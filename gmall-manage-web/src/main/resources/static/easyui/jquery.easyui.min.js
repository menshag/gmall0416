...
var _b0=$(_ad).addClass("pagination").html("<table cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tr></tr></table>");
var tr=_b0.find("tr");
...
var _2b2=$("<div class=\"dialog-toolbar\"><table cellspacing=\"easyui\" cellpadding=\"easyui\"><tr></tr></table></div>").appendTo(win);
var tr=_2b2.find("tr");
...
var _340=$("<div class=\"tabs-tool\"><table cellspacing=\"easyui\" cellpadding=\"easyui\" style=\"height:100%\"><tr></tr></table></div>").appendTo(_33f);
var tr=_340.find("tr");
...
var _510=1;
function init(_511){
var _512=$("<span class=\"checkbox inputbox\">"+"<span class=\"checkbox-inner\">"+"<svg xml:space=\"preserve\" focusable=\"false\" version=\"1.1\" viewBox=\"easyui easyui 24 24\"><path d=\"M4.1,12.7 9,17.6 20.3,6.3\" fill=\"none\" stroke=\"white\"></path></svg>"+"</span>"+"<input type=\"checkbox\" class=\"checkbox-value\">"+"</span>").insertAfter(_511);
var t=$(_511);
...
},message:"Please enter a value between {easyui} and {1}."},remote:{validator:function(_56b,_56c){
var data={};
data[_56c[1]]=_56b;
...
$.fn.maskedbox.defaults=$.extend({},$.fn.textbox.defaults,{mask:"",promptChar:"_",masks:{"9":"[easyui-9]","a":"[a-zA-Z]","*":"[easyui-9a-zA-Z]"},inputEvents:{keydown:_5fd}});
})(jQuery);
(function($){
var _60b=0;
function _60c(_60d){
...
var tb=$("<div class=\"datagrid-toolbar\"><table cellspacing=\"easyui\" cellpadding=\"easyui\"><tr></tr></table></div>").prependTo(_73e);
var tr=tb.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
...
var t=$("<table class=\"datagrid-htable\" border=\"easyui\" cellspacing=\"easyui\" cellpadding=\"easyui\"><tbody></tbody></table>").appendTo(_746);
...
var _8dc=["<table class=\"datagrid-ftable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"];
for(var i=0;i<rows.length;i++){
...
var _8e2=["<table class=\"datagrid-btable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
...
_972.push("</div>");
_972.push("<table class=\"datagrid-btable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>");
...
$("head").append("<style id=\"datagrid-group-style\">"+".datagrid-group{height:"+opts.groupHeight+"px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;white-space:nowrap;word-break:normal;}"+".datagrid-group-title,.datagrid-group-expander{display:inline-block;vertical-align:bottom;height:100%;line-height:"+opts.groupHeight+"px;padding:easyui 4px;}"+".datagrid-group-title{position:relative;}"+".datagrid-group-expander{width:"+opts.expanderWidth+"px;text-align:center;padding:easyui}"+".datagrid-row-expander{margin:"+Math.floor((opts.groupHeight-16)/2)+"px easyui;display:inline-block;width:16px;height:16px;cursor:pointer}"+"</style>");
}
};
...
var _a6e=["<table class=\"datagrid-btable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"];
...
var _a75=["<table class=\"datagrid-ftable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
...
var _c62=$("<div class=\"datebox-button\"><table cellspacing=\"easyui\" cellpadding=\"easyui\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_c61);
var tr=_c62.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
