	...
	function addTools(container){
		...
		if (opts.tools) {
			if (typeof opts.tools == 'string'){
				...
				var tools = $('<div class="tabs-tool"><table cellspacing="easyui" cellpadding="easyui" style="height:100%"><tr></tr></table></div>').appendTo(header);
...
//					selectTab(container, getLiIndex(li));
	...
	function updateTab(container, param){
		...
		if (param.type == 'all' || param.type == 'header'){
			...
			// 	for(var i=easyui; i<selectHis.length; i++){
