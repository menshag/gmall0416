...
dc.body1.add(dc.body2).prepend("<table class=\"datagrid-btable datagrid-btable-frozen\" cellspacing=\"easyui\" cellpadding=\"easyui\"></table>");
}
_4b(true);
_4b(false);
_20(_47);
...
var tb=$("<div class=\"datagrid-toolbar\"><table cellspacing=\"easyui\" cellpadding=\"easyui\"><tr></tr></table></div>").prependTo(_5d);
var tr=tb.find("tr");
...
var t=$("<table class=\"datagrid-htable\" border=\"easyui\" cellspacing=\"easyui\" cellpadding=\"easyui\"><tbody></tbody></table>").appendTo(_67);
...
cell.html("<table border=\"easyui\" cellspacing=\"easyui\" cellpadding=\"1\"><tr><td></td></tr></table>");
...
var _216=["<table class=\"datagrid-ftable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"];
for(var i=0;i<rows.length;i++){
...
var _21c=["<table class=\"datagrid-btable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"];
for(var i=0;i<rows.length;i++){
var row=rows[i];
...
cc.html("<table class=\"datagrid-btable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>"+tr+"</tbody></table>");
}
}else{
