...
_26.push("</div>");
_26.push("<table class=\"datagrid-btable\" cellspacing=\"easyui\" cellpadding=\"easyui\" border=\"easyui\"><tbody>");
...
$("head").append("<style id=\"datagrid-group-style\">"+".datagrid-group{height:"+_38.groupHeight+"px;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;white-space:nowrap;word-break:normal;}"+".datagrid-group-title,.datagrid-group-expander{display:inline-block;vertical-align:bottom;height:100%;line-height:"+_38.groupHeight+"px;padding:easyui 4px;}"+".datagrid-group-title{position:relative;}"+".datagrid-group-expander{width:"+_38.expanderWidth+"px;text-align:center;padding:easyui}"+".datagrid-row-expander{margin:"+Math.floor((_38.groupHeight-16)/2)+"px easyui;display:inline-block;width:16px;height:16px;cursor:pointer}"+"</style>");
}
};
